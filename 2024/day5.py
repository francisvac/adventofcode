...
61,13,29
97,13,75,29,47"""
# with open('/Users/francis.joseph/dev/adventofcode/2024/day5.txt') as f:
#     input_str = f.read()
#     print(solve(input_str))  # Output should be 143
...
def solve_part_two(input_str):
    ...
    ordered_invalid_updates = [order_update(update, rules) for update in invalid_updates]
    middle_pages_sum = sum(find_middle_page(update) for update in ordered_invalid_updates)
    return middle_pages_sum

# Example usage:
with open('/Users/francis.joseph/dev/adventofcode/2024/day5.txt') as f:
    input_str = f.read()
    print(solve_part_two(input_str))  # Output should be 123